...
public interface CouponService {
    ...
    Coupon addCoupon(String name, String percentage,int user_id) throws SQLException, ServiceException;
    ...
    List<Coupon> getCouponsByUsers(int user_id)throws SQLException,ServiceException;
}
